    ...
    <>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <article className="rounded-lg bg-white p-5 shadow-sm ring-1 ring-ink/10">
          ...
          <p className="mt-3 text-sm leading-6 text-steel">Public booking accepts starts from 6:00 AM through 8:00 PM so evening jobs can still fit inside the 6:00 AM to 10:00 PM service day.</p>
