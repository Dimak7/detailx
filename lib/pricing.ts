...
export const pricedServices = [
  {
    ...
    description: "A complete reset for the cabin, paint, wheels, trim, glass, and final handoff.",
  ...
  },
  {
    ...
    code: "EX",
    tone: "Gloss wash",
    description: "Foam wash, wheels, trim finish, glass, tires, and a sharper exterior handoff.",
  ...
  },
  {
    ...
    description: "Tint requests structured for a cleaner profile, heat control, and a finished cabin feel.",
...
export function getEstimatedPrice(service: string, vehicleType: string) {
  ...
  return `Starting at $${servicePricing.startingPrice}${servicePricing.plus ? "+" : ""}`;
}
